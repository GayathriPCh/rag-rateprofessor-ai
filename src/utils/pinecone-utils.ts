...
export async function chatbotResponse(userQuery: string) {
  try {
    ...
    const prompt = `You are an assistant to help out the user with providing existing reviews of professors they ask for. If they ask to list all professors available, do list out all the content you find here:  Use the following context to answer the user's question:
